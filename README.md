...
In contrast to the Prevalence/Consumption and Morbidity/Mortality tables, the relative risk sheet should be adapted from the provided example table rather than generated by 

-   *IM* &ndash; See [above](#im).

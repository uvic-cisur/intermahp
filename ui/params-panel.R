...
wellPanel(
  ...
  dropdownButton(
    ...
    fluidRow(
      column(6, numericInput(inputId = "m_lb", label = "Male Lower Bound", value = 15, min = 0,  max = 250, step = 1)),
      column(6, numericInput(inputId = "m_ub", label = "Male Upper Bound", value = 30, min = 0,  max = 250, step = 1))),
    fluidRow(
